            ...
            for (var i = 0; i < classesArray.length; i++) {
                ...
                buildUI += React.createElement(
                    ...
                    React.createElement(
                        "h2",
                        null,
                        JSON.stringify(classesArray[i].times),
                        "  |  ",
                        JSON.stringify(classesArray[i].title)
                    )
                );
            }
...
function renderWeekGlance() {
    ...
    if (mainCourses < 1) {
        ...
        ReactDOM.render(React.createElement(
            ...
            React.createElement(DisplayDay, { key: "monday", data: weekDayArray[0], day: "Monday" }),
            React.createElement(DisplayDay, { key: "tuesday", data: weekDayArray[1], day: "Tuesday" })
        ), domContainer);
    }
}