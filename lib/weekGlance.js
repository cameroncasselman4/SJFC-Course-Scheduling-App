    ...
    buildUI() {
        ...
        if (classesArray.length == 0) {
            renderData.push(React.createElement(
                "div",
                { className: "week-glance-row", key: currentDay },
                React.createElement(
                    "h4",
                    null,
                    "No Classes"
            ...
            for (var i = 0; i < classesArray.length; i++) {
                if (classesArray[i].times == "") renderData.push(React.createElement(
                    "div",
                    { className: "week-glance-row", key: classesArray[i].title },
                    React.createElement(
                        "h4",
                        null,
                        classesArray[i].title
                    )
                ));else renderData.push(React.createElement(
                    "div",
                    { className: "week-glance-row", key: classesArray[i].title },
                    React.createElement(
                        "h4",
